<footer class="main-footer">
		...
		<strong>Copyright &copy; <?php echo date("Y");?> <a href="<?php base_url();?>">SECIOT</a>.</strong> All rights
		reserved.
</footer>
...
$(function () {
    $("#table").DataTable({
		"responsive": true,// para que las tablas sean responsive en celu
		"autoWidth": false,
		language: {
...
connectTimeout: 4000,
clientId: 'Web_Page_CSE'+ Math.round(Math.random() * (0- 10000) * -1), //Número aleatorio evitamos que existan 2 o mas id idénticos
username: 'CSE-USER', //free user demo
password: 'PASS', //free password demo
keepalive: 60,
clean: true,
...
const WebSocket_URL = 'wss://xxxxx.com:8080/mqtt'
...
<?php foreach($dispositivos as $dispositivo):?>//traemos cada dispositivo y lo suscribimos
	...
	client.publish('Primer mensaje', 'Primer Topic', (error) => {
