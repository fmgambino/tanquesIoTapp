                  ...
                  <?php if(!empty($dispositivos)):?>
                   <?php foreach($dispositivos as $dispositivo):?>
                      ...
                      <tr>
                              ...
                              <td data-title="Nombre"><?php echo $dispositivo->dispositivo_nombre;?></td>
                              <td data-title="Serie"><?php echo $dispositivo->dispositivo_serial;?></td>
                              <td data-title="Fecha"><?php echo $dispositivo->dispositivo_date;?></td>
                              <td data-title="Estado">

                               <?php if ( $dispositivo->dispositivo_estado == 1):?>
                          ...
                          <td data-title="Acciones"align="center">
                              ...
                              <div class="btn-group">
                                ...
                                onclick="selDevice('<?php echo $dispositivo->dispositivo_id?>','<?php echo $dispositivo->dispositivo_nombre?>','<?php echo $dispositivo->dispositivo_serial?>');">
                                  <i class="fa fa-edit"></i>
                                </button>

                                <a href="<?php echo base_url()?>dispositivos/delete/<?php echo $dispositivo->dispositivo_id;?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
